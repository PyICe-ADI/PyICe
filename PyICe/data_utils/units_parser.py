class Units_Parser():
    ...
    def parse(self, units):
        ...
        lengths = list(range(1,max(len(symbol) for symbol in self.symbols.keys())+1))
        ...
        return {"MULT": multiplier * divisor, "UNITS" : f"{mult_strings}/{div_strings}", "NUMERATOR_UNITS":mult_strings, "DENOMINATOR_UNITS":div_strings}
