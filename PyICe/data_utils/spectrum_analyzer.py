...
class spectrum_analyzer():
    ...
    def compute_fft(self, signal):
        ...
        >>> from PyICe.data_utils.spectrum_analyzer import spectrum_analyzer
        >>> hasattr(spectrum_analyzer, 'compute_fft')
        True
        ...
        self.yf = dBV(2.0 / self.npoints / 2**-0.5 *
                      numpy.abs((fft(self.values))[0:self.npoints // 2]))
        # Reconstruct time step, *** ALL TIME STEPS NEED TO BE THE SAME ***
        self.xf = fftfreq(
            self.npoints,
            self.times[1] -
            self.times[0])[
    ...
    def get_RBW(self):
        ...
        >>> from PyICe.data_utils.spectrum_analyzer import spectrum_analyzer
        >>> hasattr(spectrum_analyzer, 'get_RBW')
        True
    ...
    def get_record_duration(self):
        ...
        >>> from PyICe.data_utils.spectrum_analyzer import spectrum_analyzer
        >>> hasattr(spectrum_analyzer, 'get_record_duration')
        True
    ...
    def get_record_length(self):
        ...
        >>> from PyICe.data_utils.spectrum_analyzer import spectrum_analyzer
        >>> hasattr(spectrum_analyzer, 'get_record_length')
        True
