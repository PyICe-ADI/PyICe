...
class pds_reader():
    ...
    def build_record(self):
        ...
        for test_group in self.test_groups:
            ...
            # Is this always true, this schema is a disaster!
            test_number = int(test_group.split("_")[0][1:])
            for test in self.data[test_group]:
                ...
                for column, param in this_test:
                    parameter[column] = param.replace(
                        COMMA_REPLACEMENT_STRING, ",")
    ...
    def generate_excel_report(self, file_name):
        ...
        for test_group in self.results:
            ...
            for test in self.results[test_group]:
                ...
                for column in columns:
                    worksheet.write(
                        row_num, column_num, self.results[test_group][test][column])
                    column_num += 1
                row_num += 1
        workbook.close()
