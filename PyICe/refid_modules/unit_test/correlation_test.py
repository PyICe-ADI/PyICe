...
@pytest.mark.parametrize('filename, part_id, kwargs', [(corr_ex, ['2'],
                                             ...
                                             (stwe_ex, ['1'], {'testname': 'VOUT CH1', 'bench_data': [0.8], 'units': 'V',
                                                        'percent': 3}),
                                             (stwe_ex, '1', {'testname': 'VOUT CH1', 'bench_data': 0.8, 'units': 'V',
                                                           'upper_diff': 0.1, 'lower_diff': -0.1, 'temperature': 25}),
                                             (stwe_ex, '1', {'testname': 'VOUT CH1', 'bench_data': 0.8, 'units': 'V',
                                                           'upper_diff': 0.1, 'lower_diff': -0.1, 'temperature': '25'}),
                                             (stwe_ex, '2', {'testname': 'VOUT CH1', 'bench_data': 0.8, 'units': 'V',
                                                           'upper_diff': 0.1, 'lower_diff': -0.1, 'temperature': '25'})
                                             ]
                         )
...
@pytest.mark.parametrize('filename, part_id, kwargs', [(corr_ex, ['2'],
                                                        {'testname': 'Src out I       <> EA_SRC', 'bench_data': [1.3],
                                                         'units': 'A', 'upper_diff': 1, 'lower_diff': -1}),
                                                       (stwe_ex, ['1'], {'testname': 'VOUT CH1', 'bench_data': 0, 'units': 'V',
                                                                         'upper_diff': 0.1, 'lower_diff': -0.1}),
                                                       (stwe_ex, ['1'], {'testname': 'VOUT CH1', 'bench_data': [1000], 'units': 'mV',
                                                                         'upper_diff': 0.1, 'lower_diff': None}),
                                                       (stwe_ex, '1', {'testname': 'VOUT CH1', 'bench_data': 1.2, 'units': 'V',
                                                                       'upper_diff': 0.1, 'lower_diff': -0.1, 'temperature': 25}),
                                                       (stwe_ex, '2', {'testname': 'VOUT CH1', 'bench_data': 1.2, 'units': 'V',
                                                                       'upper_diff': 0.1, 'lower_diff': -0.1, 'temperature': '25'})
                                                       ]
                         )
