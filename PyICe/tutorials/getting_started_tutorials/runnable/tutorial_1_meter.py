...
my_a34401_interface = interface_factory.get_visa_serial_interface(
...
print(
    f"Measuring 'vmeas' using by circumventing the channel_master and using my_a34401 (not recommended), reading = {reading}V.")

# This gets the channel object. It could also be obtained from my_a34401
vmeas_channel_object = channel_master['vmeas']
reading = vmeas_channel_object.read()
print(
    f"Measuring 'vmeas' by retreiving the actual channel first and asking it to read. Reading = {reading}.")

reading = channel_master['vmeas'].read()
print(
    f"Measuring 'vmeas' using the condensed version of rereiving the channel. Reading = {reading}.")
