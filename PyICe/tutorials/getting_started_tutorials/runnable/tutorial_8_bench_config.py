...
if __name__ == '__main__':
    ...
    test_components.add_component(
        lab_components.Agilent_3497x("AGILENT_3497x"))
    test_components.add_component(
        lab_components.Agilent_34908A("AGILENT_34908A"))
    test_connections.add_connection(
        test_components.get_components()["AGILENT_3497x"]["BAY1"],
        test_components.get_components()["AGILENT_34908A"]["BAY"])
    ...
    mlogger.write(
        "bench_connections",
        test_connections.get_readable_connections())
    mlogger.log()
