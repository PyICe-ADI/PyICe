...
database = sqlite_data(table_name = '{group1[0]}', database_file = "./data/battery_data.sqlite")
...
database = sqlite_data(table_name = '{group1[1]}', database_file = "./data/battery_data.sqlite")
