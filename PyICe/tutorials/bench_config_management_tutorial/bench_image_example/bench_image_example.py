...
if __name__ == "__main__":
    ...
    test_connections = bench_configuration_management.connection_collection(
        "bench_image_example")
    test_connections.add_connection(
        compos["AGILENT_3497x"]["BAY1"],
        compos["AGILENT_34908A"]["BAY"])
    test_connections.add_connection(
        compos["AGILENT_3497x"]["BAY2"],
        compos["AGILENT_34901A_2"]["BAY"])
    test_connections.add_connection(
        compos["AGILENT_3497x"]["BAY3"],
        compos["AGILENT_34901A_3"]["BAY"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER1_MEAS"],
        compos["AGILENT_34901A_2"]["DIFF_1-4"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER2_MEAS"],
        compos["AGILENT_34901A_2"]["DIFF_5-8"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER3_MEAS"],
        compos["AGILENT_34901A_2"]["DIFF_9-12"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER5_MEAS"],
        compos["AGILENT_34901A_2"]["DIFF_13-16"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER6_MEAS"],
        compos["AGILENT_34901A_2"]["DIFF_17-20"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER7_MEAS"],
        compos["AGILENT_34901A_3"]["DIFF_1-4"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER8_MEAS"],
        compos["AGILENT_34901A_3"]["DIFF_5-8"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["MEAS_A"],
        compos["AGILENT_34908A"]["SINGLE_1-8"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["MEAS_B"],
        compos["AGILENT_34901A_3"]["DIFF_9-12"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["MEAS_C"],
        compos["AGILENT_34908A"]["SINGLE_9-16"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["DZ"],
        compos["AGILENT_34908A"]["DZ"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER1"],
        compos["HAMEG"]["VOUT1"])
    test_connections.add_connection(
        compos["CONFIGURATORXT"]["POWER8"],
        compos["HAMEG"]["VOUT2"])
    ...
    visualizer = bench_visualizer.visualizer(
        ...
        locations=visualizer_locations.component_locations().locations)
    visualizer.generate(
