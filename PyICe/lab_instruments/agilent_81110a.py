...
class Agilent_81110a(Agilent_8110a):
    ...
    def add_channel_pattern_update(self, channel_name):
        ...
        new_channel.set_write_delay(0.1) # HP81110A seems to generate wayward STROBE outputs during otherwise innocuous SCPI commands. This helps prevent scope arming and such.
