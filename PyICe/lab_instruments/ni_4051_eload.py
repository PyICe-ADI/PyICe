...
class pxie_4051(instrument):  # noqa: F405
    ...
    def add_channel_current_level(self, channel_name):
        new_channel = channel(  # noqa: F405
            channel_name + "_current", write_function=lambda value: self.set_current_level(value)
        )
    ...
    def add_channel_current_level_range(self, channel_name):
        new_channel = channel(  # noqa: F405
            channel_name + "_current_level_range", write_function=lambda value: self.set_current_level_range(value)
        )
    ...
    def add_channel_nplc(self, channel_name):
        new_channel = channel(channel_name + "_nplc", write_function=lambda value: self.set_nplc(value))  # noqa: F405
    ...
    def add_channel_current_rise_slew_rate(self, channel_name):
        new_channel = channel(  # noqa: F405
            channel_name + "_current_rise_slew_rate", write_function=lambda value: self.set_current_level_rise_slew_rate(value)
        )
        self._add_channel(new_channel)
        return new_channel
    ...
    def add_channel_current_fall_slew_rate(self, channel_name):
        new_channel = channel(  # noqa: F405
            channel_name + "_current_fall_slew_rate", write_function=lambda value: self.set_current_level_fall_slew_rate(value)
        )
        self._add_channel(new_channel)
        return new_channel

    def add_channel_isense(self, channel_name):
        new_channel = channel(channel_name + "_isense", read_function=lambda: self.get_current_sense())  # noqa: F405
        self._add_channel(new_channel)
        return new_channel

    def add_channel_vsense(self, channel_name):
        new_channel = channel(channel_name + "_vsense", read_function=lambda: self.get_voltage_sense())  # noqa: F405
        self._add_channel(new_channel)
        return new_channel
