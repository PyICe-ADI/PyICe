...
class hp_3458a(instrument):
    ...
    def __init__(self, interface_visa):
        ...
        # EOI line set true with last byte of last reading
        self.get_interface().write(('END 1'))
    ...
    def add_channel_dc_voltage(self, channel_name, NPLC=50, range='AUTO'):
        ...
        self.meter_channel = channel(
            channel_name, read_function=self._read_meter)
    ...
    def add_channel_NPLC(self, channel_name):
        ...
        meter_config_channel = channel(
            channel_name,
            write_function=lambda nplc: self._configure_meter(
                NPLC=nplc))
    ...
    def add_channel_range(self, channel_name):
        ...
        meter_config_channel = channel(
            channel_name,
            write_function=lambda rng: self._configure_meter(
                range=rng))
        return self._add_channel(meter_config_channel)
