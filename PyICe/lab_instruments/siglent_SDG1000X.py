...
>>> from PyICe.lab_instruments.siglent_SDG1000X import SiglentIOError
...
class siglent_SDG1000X(scpi_instrument):
    ...
    def __init__(self, instrument_visa):
        ...
        # Keep an activity log in an attempt to recover from random I/O
        # crashes.
        self.activity_log = OrderedDict()
        self.low_voltage = 0
        self.high_voltage = 0
    ...
    def append_activity_log(self, command, argument):
        ...
        self.activity_log[command] = command + argument
    ...
    def _try_command(self, command, argument):
        ...
        try:
            ...
            # raise SiglentIOError(lab_utils.build_banner('Siglent successfully
    ...
    def add_channel_burst(self, channel_name, channel_number):
        ...
        self.add_channel_burstwave_state(
            channel_name + "_state", channel_number)
        self.add_channel_burstwave_gate_ncyc(
            channel_name + "_gate_ncyc", channel_number)
        self.add_channel_burstwave_trigger_source(
            channel_name + "_trigger_source", channel_number)
        self.add_channel_burstwave_trigger_out_mode(
            channel_name + "_trigger_out_mode", channel_number)
        self.add_channel_burstwave_cycles(
            channel_name + "_cycles", channel_number)
        self.add_channel_burstwave_trigger_delay(
            channel_name + "_trigger_delay", channel_number)
        self.add_channel_burstwave_shape(
            channel_name + "_shape", channel_number)
        self.add_channel_burstwave_low_voltage(
            channel_name + "_low_voltage", channel_number)
        self.add_channel_burstwave_high_voltage(
            channel_name + "_high_voltage", channel_number)
        self.add_channel_burstwave_pulse_width(
            channel_name + "_pulse_width", channel_number)
        self.add_channel_burstwave_rise_time(
            channel_name + "_risetime", channel_number)
        self.add_channel_burstwave_fall_time(
            channel_name + "_falltime", channel_number)
        self.add_channel_burstwave_period(
            channel_name + "_period", channel_number)
        self.add_channel_burstwave_delay(
            channel_name + "_delay", channel_number)
        self.add_channel_burstwave_trigger(
    ...
    def add_channel_continuous(self, channel_name, channel_number):
        ...
        self.add_channel_continuouswave_shape(
            channel_name + "_shape", channel_number)
        self.add_channel_continuouswave_low_voltage(
            channel_name + "_low_voltage", channel_number)
        self.add_channel_continuouswave_high_voltage(
            channel_name + "_high_voltage", channel_number)
        self.add_channel_continuouswave_width(
            channel_name + "_pulse_width", channel_number)
        self.add_channel_continuouswave_period(
            channel_name + "_period", channel_number)
        self.add_channel_continuouswave_rise_time(
            channel_name + "_risetime", channel_number)
        self.add_channel_continuouswave_fall_time(
            channel_name + "_falltime", channel_number)
        return enable_channel

    def add_generic_channels(self, channel_name, channel_number):
        """Add a generic channels.
        Creates and registers a new generic channels.

        Appends a new generic channels entry to the object's internal collection.
        ...
        Returns:
            The newly created channel objects.
    ...
    def add_channel_enable(self, channel_name, channel_number):
        ...
        new_channel = integer_channel(
            channel_name,
            size=1,
            write_function=lambda value: _write_output_enable(
                channel_number,
                value))
    ...
    def add_channel_outputz(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_outputz(
                channel_number,
                value))
        new_channel.add_preset(
            50,
            'Expect a 50Ω load. Output voltage scaled accordingly given its fixed 50Ω source impedance.')
        new_channel.add_preset(
            "HZ",
            'Expect an infinite load. Output voltage scaled accordingly given its high impedance source impedance.')
        return self._add_channel(new_channel)
    ...
    def add_channel_DC(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_DC(
                channel_number,
                value))
    ...
    def add_channel_burstwave_gate_ncyc(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_gate_ncyc(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_state(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_state(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_trigger_source(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_trigger_source(
                channel_number,
                value))
    ...
    def add_channel_burstwave_trigger_out_mode(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burst_trigger_out_mode(
                channel_number,
                value))
    ...
    def add_channel_burstwave_cycles(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_cycles(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_trigger_delay(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_trigger_delay(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_shape(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_shape(
                channel_number,
                value))
    ...
    def add_channel_burstwave_low_voltage(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_low_voltage(
                channel_number,
                value))
    ...
    def add_channel_burstwave_high_voltage(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_high_voltage(
                channel_number,
                value))
        new_channel.set_write_delay(0.25)
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_pulse_width(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_width(
                channel_number,
                value))
    ...
    def add_channel_burstwave_period(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_period(
                channel_number,
                value))
    ...
    def add_channel_burstwave_rise_time(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_rise_time(
                channel_number,
                value))
    ...
    def add_channel_burstwave_fall_time(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_fall_time(
                channel_number,
                value))
        new_channel.add_preset('16.8e-9', 'Minimum Value')
        new_channel.set_min_write_limit(16.8e-9)
    ...
    def add_channel_burstwave_delay(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_burstwave_delay(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_burstwave_trigger(self, channel_name, channel_number):
        ...
        self.trigger_channel = channel(
            channel_name,
            write_function=lambda value: _send_burstwave_trigger(
                channel_number,
                value))
    ...
    def add_channel_continuouswave_shape(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_shape(
                channel_number,
                value))
        new_channel.add_preset("SINE", 'Sine Waveform')
        new_channel.add_preset("SQUARE", 'Square Waveform')
    ...
    def add_channel_continuouswave_low_voltage(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_low_voltage(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_continuouswave_high_voltage(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_high_voltage(
                channel_number,
                value))
        return self._add_channel(new_channel)
    ...
    def add_channel_continuouswave_width(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_width(
                channel_number,
                value))
        new_channel.add_preset('32.6e-9', 'Minimum Value')
        new_channel.set_min_write_limit(32.6e-9)
    ...
    def add_channel_continuouswave_period(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_period(
                channel_number,
                value))
        new_channel.set_write_resolution(decimal_digits=10)  # 100ps resolution
        return self._add_channel(new_channel)
    ...
    def add_channel_continuouswave_rise_time(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_rise_time(
                channel_number,
                value))
        new_channel.add_preset('16.8e-9', 'Minimum Value')
        new_channel.set_min_write_limit(16.8e-9)
    ...
    def add_channel_continuouswave_fall_time(
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_continuouswave_fall_time(
                channel_number,
                value))
        new_channel.add_preset('16.8e-9', 'Minimum Value')
        new_channel.set_min_write_limit(16.8e-9)
    ...
    def add_channel_phase_mode(self, channel_name):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_phase_mode(value))
    ...
    def add_channel_sync_out(self, channel_name, channel_number):
        ...
        new_channel = channel(
            channel_name,
            write_function=lambda value: _write_sync_out(
                channel_number,
                value))
