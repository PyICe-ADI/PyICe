...
firmata.add_channel_digital_latch(
    'latch6',
    firmata['pin6_in_pu'],
...
spi_if = spi_interface.spi_bitbang(SCK_channel=firmata.add_channel_digital_output('SCK', 8),
                                   MOSI_channel=firmata.add_channel_digital_output(
                                       'MOSI', 9),
                                   MISO_channel=None,
                                   SS_channel=firmata.add_channel_digital_output(
                                       '_SS', 10),
                                   CPOL=0,
                                   CPHA=0,
                                   SS_POL=0,
...
spi_inst = spi_instrument.spiInstrument(
    name='spi_test_instrument',
    spiInterface=spi_if,
    write_shift_register=sr)
