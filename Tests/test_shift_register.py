...
def setup_inst():
    ...
    sr.add_bit_field(
        ...
        bit_field_bit_count=4,
        description='test register')
    sr.add_bit_field(
        bit_field_name='second',
        bit_field_bit_count=8,
        description='second register')
    sr.add_bit_field(
        bit_field_name='third',
        bit_field_bit_count=5,
    ...
    spi_inst = spi_instrument.spiInstrument(
        name=sr_concat.get_name(),
        spiInterface=spi_if,
        write_shift_register=sr_concat,
        read_shift_register=sr_concat)
