...
# Max 1998 channels to stay within SQLITE_MAX_COLUMN, which defaults to
# 2000 (+rowid, +datetime), but only 1998 variables can be passed in two
# tries (+datetime but not rowid).
for i in range(1996):
